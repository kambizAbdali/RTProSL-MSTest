...
{
    public class HttpPostAPI : APIHelper
    {
        public HttpPostAPI()
        {
        ...
        private void InitializeApiRequests()
        {
            ...
            string PaymentTypePayload = "{ \"id\": " + id + ", \"description\": \"ApiTest\" }";
            ...
            apiRequests = new List<(HttpMethod Method, string Url, string paramdata)>
                         {
                                 (HttpMethod.Post, "extapi/v1/Customer", customerPayload),
                                 (HttpMethod.Post, "extapi/v1/Department", departmentPayload),
                                 (HttpMethod.Post, "extapi/v1/Parent", parentPayload),
                                 (HttpMethod.Post, "extapi/v1/PaymentType", PaymentTypePayload),
                                 (HttpMethod.Post, "extapi/v1/Tax",taxPayload),
                         };
        }
        ...
        static async Task ExecuteApiRequests()
        {
            ...
            {
                var response = await CallAPI(api, "application/json");
